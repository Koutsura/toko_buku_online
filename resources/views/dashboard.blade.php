        ...
        <div class="row justify-content-center">
            ...
            @foreach($buku as $item)
                ...
                @if($item->kategori != $currentCategory)
                    <div class="col-12 category-title" data-kategori="{{ Str::slug($item->kategori, '_') }}">
                ...
                <div class="col-md-4 mb-4 book-card" data-kategori="{{ Str::slug($item->kategori, '_') }}">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('sale.create', ['id' => $item->id]) }}" class="btn btn-primary mt-3 w-100">
                                Tambah ke Cart
                            </a>
                        </div>
                    </div>
